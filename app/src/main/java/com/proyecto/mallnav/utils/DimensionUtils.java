...
import com.proyecto.mallnav.application.MallnavApp;

public class DimensionUtils {

    public static int STROKE_WIDTH = (int) MallnavApp.AppContext.getResources().getDimension(R.dimen.search_stroke_width);
